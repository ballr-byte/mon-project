"""
Rewrites sender and followup scripts with:
- DAILY_LIMIT = 20
- DELAY = 120
...
for niche in ["detailing", "landscaping"]:
    ...
    path = rf"C:\peakline\followup_{niche}.py"
    with open(path, "w", encoding="utf-8") as f:
        f.write(FOLLOWUP_TEMPLATE.format(niche=niche))
    print(f"Updated followup_{niche}.py")

print("\nDone! Changes applied:")
print("- Daily limit: 20 emails per run")
print("- Delay: 120 seconds between emails")
print("- No booking link in emails (reply-based instead)")
